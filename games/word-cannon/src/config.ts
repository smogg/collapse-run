...
export const ENEMY_SPEED_RAMP = 0.3; // per second of playtime
export const ENEMY_MAX_SPEED = 120;
export const ENEMY_SPAWN_INTERVAL_BASE = 2000; // ms
export const ENEMY_SPAWN_INTERVAL_MIN = 600;
export const ENEMY_SPAWN_RAMP = 15; // ms reduction per second of playtime
...
// Debuff durations (ms)
export const DEBUFF_BLUR_DURATION = 4000;
export const DEBUFF_SCRAMBLE_DURATION = 5000;
export const DEBUFF_RUSH_DURATION = 4000;

// Powerup durations (ms)
export const POWERUP_CHAIN_DURATION = 5000;
export const POWERUP_FREEZE_DURATION = 4000;
export const POWERUP_SHIELD_DURATION = 6000;
